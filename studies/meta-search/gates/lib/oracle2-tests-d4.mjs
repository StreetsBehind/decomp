// Drop-in `tests.mjs` for the scale-d4 epic, graded by ORACLE #2 (the independent
// hand-authored oracle, src/oracle2.mjs). Depth-parameterized sibling of oracle2-tests-d1.mjs:
// domainsFor(4) is the 17-surface schema (projects + vaults + trackers + channels). Same isolated-child scoring path.
import { buildOracle2 } from '../../src/oracle2.mjs';
import { domainsFor } from '../../../build-gap/lib/scale-oracle.mjs';

const o = buildOracle2(domainsFor(4));
